...
def shake_row():
	...
	while left < right:
		...
		while x_curr < right:
			# Condition inversée pour le passage Est/droite :
			# Si l'élément courant est PLUS PETIT que le suivant, on échange.
		...
		while x_curr > left:
			# Condition inversée pour le passage Ouest/gauche :
			# Si l'élément précédent est PLUS GRAND que le courant, on échange.
...
def shake_col():
	...
	while left < right:
		...
		while y_curr < right:
			# Condition inversée pour le passage Nord/haut :
			# Si l'élément courant est PLUS PETIT que le suivant, on échange.
		...
		while y_curr > left:
			# Condition inversée pour le passage Sud/bas :
			# Si l'élément précédent est PLUS GRAND que le courant, on échange.
